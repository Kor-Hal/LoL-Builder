...
class Rune(object):
  ...
  def __init__(self, tier, kind, name, rank, cost, icon, 
               ability_power=0, armor=0, flat_armor_penetration=0, attack_damage=0, attack_speed=0, cooldown_reduction=0, 
               critical_strike_chance=0, critical_strike_damage=0, energy=0, energy_regeneration=0, experience=0, 
               gold=0, health=0, health_regeneration=0, life_steal=0, flat_magic_penetration=0, magic_resistance=0, mana=0, 

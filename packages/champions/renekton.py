...
class Renekton(champion.Champion):
  """ Renekton, the Butcher of the Sands
  
  Ref : http://leagueoflegends.wikia.com/wiki/Renekton
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               426,         # Base Health
                               87,          # Base Health per level
                               6.7,         # Base Health per 5
                               0.75,        # Base Health per 5 per level
                               100,         # Base Resource
                               0,           # Base Resource per level
                               0,           # Base Resource per 5
                               0,           # Base Resource per 5 per level
                               53.12,       # Base Attack Damage
                               3.1,         # Base Attack Damage per level
                               0.665,       # Base Attack Speed

...
class Ashe(champion.Champion):
  """ Ashe, the Frost Archer
  
  Ref : http://leagueoflegends.wikia.com/wiki/Ashe
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               395,         # Base Health
                               79,          # Base Health per level
                               4.5,         # Base Health per 5
                               0.55,        # Base Health per 5 per level
                               173,         # Base Resource
                               35,          # Base Resource per level
                               6.3,         # Base Resource per 5
                               0.4,         # Base Resource per 5 per level
                               46.3,        # Base Attack Damage
                               2.85,        # Base Attack Damage per level
                               0.658,       # Base Attack Speed
                               0.04,        # Base Attack Speed per level
                               11.5,        # Base Armor
                               3.4,         # Base Armor per level

...
class Veigar(champion.Champion):
  """ Veigar, the Tiny Master of Evil
  
  Ref : http://leagueoflegends.wikia.com/wiki/Veigar
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               250,         # Base Resource
                               55,          # Base Resource per level
                               6.9,         # Base Resource per 5
                               0.6,         # Base Resource per 5 per level
                               48.3,        # Base Attack Damage
                               2.625,       # Base Attack Damage per level
                               0.625,       # Base Attack Speed
                               0.0224,      # Base Attack Speed per level
                               12.25,       # Base Armor

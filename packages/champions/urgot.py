...
class Urgot(champion.Champion):
  """ Urgot, the Headsman's Pride
  
  Ref : http://leagueoflegends.wikia.com/wiki/Urgot
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               7.5,         # Base Resource per 5
                               0.65,        # Base Resource per 5 per level
                               48,          # Base Attack Damage
                               3.6,         # Base Attack Damage per level
                               0.644,       # Base Attack Speed

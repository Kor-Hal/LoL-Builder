...
class Cassiopeia(champion.Champion):
  """ Cassiopeia, the Serpent's Embrace
  
  Ref : http://leagueoflegends.wikia.com/wiki/Cassiopeia
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               380,         # Base Health
                               75,          # Base Health per level
                               4.85,        # Base Health per 5
                               0.5,         # Base Health per 5 per level
                               250,         # Base Resource
                               50,          # Base Resource per level
                               7.1,         # Base Resource per 5
                               0.75,        # Base Resource per 5 per level
                               47,          # Base Attack Damage
                               3.2,         # Base Attack Damage per level
                               0.647,       # Base Attack Speed
                               0.0168,      # Base Attack Speed per level
                               11.5,        # Base Armor

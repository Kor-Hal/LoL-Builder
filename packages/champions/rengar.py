...
class Rengar(champion.Champion):
  """ Rengar, the Pridestalker
  
  Ref : http://leagueoflegends.wikia.com/wiki/Rengar
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               3.6,         # Base Health per 5
                               0.4,         # Base Health per 5 per level
                               5,           # Base Resource
                               ...
                               0.0285,      # Base Attack Speed per level
                               16,          # Base Armor

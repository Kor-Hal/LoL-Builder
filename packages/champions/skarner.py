...
class Skarner(champion.Champion):
  """ Skarner, the Crystal Vanguard
  
  Ref : http://leagueoflegends.wikia.com/wiki/Skarner
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               440,         # Base Health
                               96,          # Base Health per level
                               7.5,         # Base Health per 5
                               0.85,        # Base Health per 5 per level
                               205,         # Base Resource
                               40,          # Base Resource per level
                               6.45,        # Base Resource per 5
                               0.45,        # Base Resource per 5 per level
                               54.1,        # Base Attack Damage
                               4.2,         # Base Attack Damage per level
                               0.625,       # Base Attack Speed
                               0.021,       # Base Attack Speed per level
                               19,          # Base Armor

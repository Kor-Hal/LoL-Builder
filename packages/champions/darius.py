...
class Darius(champion.Champion):
  """ Darius, the Hand of Noxus
  
  Ref : http://leagueoflegends.wikia.com/wiki/Darius
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               426,         # Base Health
                               93,          # Base Health per level
                               8.25,        # Base Health per 5
                               0.95,        # Base Health per 5 per level
                               200,         # Base Resource
                               37.5,        # Base Resource per level
                               6,           # Base Resource per 5
                               0.35,        # Base Resource per 5 per level
                               50,          # Base Attack Damage
                               3.5,         # Base Attack Damage per level
                               0.679,       # Base Attack Speed
                               0.0265,      # Base Attack Speed per level
                               20,          # Base Armor

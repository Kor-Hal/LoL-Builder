...
class Sejuani(champion.Champion):
  """ Sejuani, the Winter's Wrath
  
  Ref : http://leagueoflegends.wikia.com/wiki/Sejuani
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               52,          # Base Attack Damage
                               3.3,         # Base Attack Damage per level
                               0.67,        # Base Attack Speed
                               0.0144,      # Base Attack Speed per level
                               20.5,        # Base Armor
                               3,           # Base Armor per level
                               30,          # Base Magic Resistance
                               1.25,        # Base Magic Resistance per level
                               340,         # Base Movement Speed
                               125,         # Base Range
                               "Mana",      # Resource
                               [passive,    # Passive

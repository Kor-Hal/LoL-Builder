...
class Udyr(champion.Champion):
  """ Udyr, the Spirit Walker
  
  Ref : http://leagueoflegends.wikia.com/wiki/Udyr
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               52.91,       # Base Attack Damage
                               3.2,         # Base Attack Damage per level
                               0.658,       # Base Attack Speed
                               0.0267,      # Base Attack Speed per level
                               14.75,       # Base Armor

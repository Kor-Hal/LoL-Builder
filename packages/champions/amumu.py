...
class Amumu(champion.Champion):
  """ Amumu, the Sad Mummy
  
  Ref : http://leagueoflegends.wikia.com/wiki/Amumu
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               472,         # Base Health
                               84,          # Base Health per level
                               7.45,        # Base Health per 5
                               0.85,        # Base Health per 5 per level
                               220,         # Base Resource
                               40,          # Base Resource per level
                               6.5,         # Base Resource per 5
                               0.525,       # Base Resource per 5 per level
                               47,          # Base Attack Damage
                               3.8,         # Base Attack Damage per level
                               0.638,       # Base Attack Speed
                               0.0218,      # Base Attack Speed per level
                               18,          # Base Armor
                               3.3,         # Base Armor per level

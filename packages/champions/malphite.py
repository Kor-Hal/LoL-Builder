...
class Malphite(champion.Champion):
  """ Malphite, Shard of the Monolith
  
  Ref : http://leagueoflegends.wikia.com/wiki/Malphite
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               423,         # Base Health
                               90,          # Base Health per level
                               7.45,        # Base Health per 5
                               0.55,        # Base Health per 5 per level
                               215,         # Base Resource
                               40,          # Base Resource per level
                               6.4,         # Base Resource per 5
                               0.55,        # Base Resource per 5 per level
                               56.3,        # Base Attack Damage
                               3.375,       # Base Attack Damage per level
                               0.638,       # Base Attack Speed
                               0.034,       # Base Attack Speed per level
                               18,          # Base Armor
                               3.75,        # Base Armor per level

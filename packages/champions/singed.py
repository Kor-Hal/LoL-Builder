...
class Singed(champion.Champion):
  """ Singed, the Mad Chemist
  
  Ref : http://leagueoflegends.wikia.com/wiki/Singed
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               56.65,       # Base Attack Damage
                               3.375,       # Base Attack Damage per level
                               0.613,       # Base Attack Speed
                               0.0181,      # Base Attack Speed per level
                               18,          # Base Armor

...
class Kassadin(champion.Champion):
  """ Kassadin, the Void Walker
  
  Ref : http://leagueoflegends.wikia.com/wiki/Kassadin
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               6.95,        # Base Health per 5
                               0.5,         # Base Health per 5 per level
                               230,         # Base Resource
                               45,          # Base Resource per level
                               6.9,         # Base Resource per 5
                               0.6,         # Base Resource per 5 per level
                               52.3,        # Base Attack Damage
                               3.9,         # Base Attack Damage per level
                               0.64,        # Base Attack Speed
                               0.037,       # Base Attack Speed per level
                               14,          # Base Armor

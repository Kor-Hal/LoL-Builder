...
class Alistar(champion.Champion):
  """ Alistar, the Minotaur
  
  Ref : http://leagueoflegends.wikia.com/wiki/Alistar
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               442,         # Base Health
                               102,         # Base Health per level
                               7.25,        # Base Health per 5
                               0.85,        # Base Health per 5 per level
                               215,         # Base Resource
                               38,          # Base Resource per level
                               6.45,        # Base Resource per 5
                               0.45,        # Base Resource per 5 per level
                               55.03,       # Base Attack Damage
                               3.62,        # Base Attack Damage per level
                               0.625,       # Base Attack Speed
                               0.02125,     # Base Attack Speed per level
                               14.5,        # Base Armor

...
class Twisted_Fate(champion.Champion):
  """ Twisted Fate, the Card Master
  
  Ref : http://leagueoflegends.wikia.com/wiki/Twisted_Fate
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               46.41,       # Base Attack Damage
                               3.3,         # Base Attack Damage per level
                               0.651,       # Base Attack Speed
                               0.0322,      # Base Attack Speed per level
                               11.25,       # Base Armor
                               3.15,        # Base Armor per level

...
class Warwick(champion.Champion):
  """ Warwick, the Blood Hunter
  
  Ref : http://leagueoflegends.wikia.com/wiki/Warwick
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               428,         # Base Health
                               98,          # Base Health per level
                               7.05,        # Base Health per 5
                               0.8,         # Base Health per 5 per level
                               190,         # Base Resource
                               30,          # Base Resource per level
                               7.1,         # Base Resource per 5
                               0.6,         # Base Resource per 5 per level
                               56.76,       # Base Attack Damage
                               3.375,       # Base Attack Damage per level
                               0.679,       # Base Attack Speed
                               0.0288,      # Base Attack Speed per level
                               16,          # Base Armor

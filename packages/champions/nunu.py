...
class Nunu(champion.Champion):
  """ Nunu, the Yeti Rider
  
  Ref : http://leagueoflegends.wikia.com/wiki/Nunu
  ...
  def __init__(self):
    ...
    champion.Champion.__init__(self,
                               ...
                               51.06,       # Base Attack Damage
                               3.45,        # Base Attack Damage per level
                               0.625,       # Base Attack Speed
                               0.0225,      # Base Attack Speed per level
                               16.5,        # Base Armor
